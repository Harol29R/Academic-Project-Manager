...
* Carga de imágenes almacenadas en base de datos (BLOB)
* Carga de archivos PDF almacenados en el sistema de archivos
* Clasificación por tipo de trabajo, curso y especialidad
